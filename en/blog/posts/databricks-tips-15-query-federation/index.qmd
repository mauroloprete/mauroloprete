...
Federation brings data in from outside without copying it; [Delta Sharing and the open formats](../databricks-tips-13-opensharing/) share it outward without copying it. It's the same idea in both directions: the data stays where it lives, and what travels is the query, not the file.
:::
...
::: callout-note
## The docs say one thing; the plan shows another
