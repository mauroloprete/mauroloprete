...
5.  **Don't mix it with partitions.** If you're coming from a partitioned table, migrate for real (section 7); don't expect `CLUSTER BY` to coexist with `PARTITIONED BY`.
