...
-   **Model Serving Endpoint + AI Gateway** — rate limits, guardrails, PII, jailbreak
...
**Eso es todo.** 4 comandos → 6 recursos en producción.

[experiment · vector search · AI gateway · Lakebase · app · job]{style="color: #94a3b8; font-size: 0.85em;"}
...
## Gotcha #8: Direct Engine — issues abiertos
...
| **Unity AI Gateway V2** | Guardrails LLM-based (jailbreak, hallucination) — funciona con Apps via `user_api_scopes` | {{< fa flask >}} Beta |
