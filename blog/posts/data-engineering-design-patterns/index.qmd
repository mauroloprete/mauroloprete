...
```{#lst-full-loader .python lst-cap="Full Loader: sobreescritura completa de tabla de dimensiones"}
...
```{#lst-incremental-loader .python lst-cap="Incremental Loader: ingesta por high watermark con PySpark"}
...
```{#lst-cdc-merge .sql lst-cap="CDC con MERGE en Delta Lake: inserts, updates y deletes"}
...
```{#lst-compactor .sql lst-cap="Compactor: OPTIMIZE para consolidar archivos pequeños en Delta"}
