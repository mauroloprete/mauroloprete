...
- **Modelos de AI**: compartir un modelo registrado para que el partner lo use, sin mandarle los weights por WeTransfer.
- **Agent skills**: la lógica reutilizable de un agente — herramientas, instrucciones, contexto semántico — empaquetada y compartible entre organizaciones.
- **Genie Agents** (Beta): compartís una experiencia de chat en lenguaje natural sobre tus datos. El partner pregunta en su idioma y Genie responde con tus tablas por abajo — sin que el partner vea las tablas, ni las instrucciones del agente. Este anuncio lo habíamos anticipado en el [día 3 de DAIS](../dais-2026-day-3/).
