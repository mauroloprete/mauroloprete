...
```{#lst-plan-standard .default lst-cap="Plan real del run STANDARD: HashAggregate + Exchange clásicos de Spark"}
...
```{#lst-plan-photon .default lst-cap="Plan real del run PHOTON: los mismos pasos, todos los nodos en Photon"}
PhotonResultStage
+- PhotonColumnarToRow
