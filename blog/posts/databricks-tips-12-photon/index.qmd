...
*Siguiente post de la serie: [OpenSharing — compartir sin copiar](../databricks-tips-13-opensharing/). Y después: Liquid Clustering, el reemplazo de particiones y Z-ORDER que reordena tus datos solo.*
