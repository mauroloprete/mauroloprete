...
generate_cover(
  title = "Omnigent: el meta-harness\npara orquestar tus agentes AI",
  subtitle = "Compose, govern y share:\nClaude Code + Codex + Pi en una capa",
  icon_char = "\U0001F916",
  out_path = "blog/posts/omnigent-meta-harness/cover.png"
)
