...
El experimento es simple: una tabla de 5 millones de filas en un Postgres, una query que se empuja entera, otra que no, y el plan de cada una para ver la diferencia. El Postgres lo pone [Neon](https://neon.com), que regala uno serverless con endpoint público y sin pedir tarjeta. En [spark-de-ideas-labs/tips/query-federation](https://github.com/mauroloprete/spark-de-ideas-labs/tree/main/tips/query-federation) está todo: el paso a paso para crear la base por UI o por CLI, los SQL y las salidas de referencia.
