...
#| fig-height: 4
#| fig-align: center
#| fig-cap: "Antes vs después: equipo de datos centralizado como cuello de botella vs dominios con ownership de sus Data Products."
...
```{#lst-data-product .yaml lst-cap="Definición de un Data Product con SLA, schema y consumidores"}
...
#| fig-height: 3.5
#| fig-align: center
#| fig-cap: "Self-Serve Data Platform: la plataforma provee templates, CI/CD, governance y compute a los dominios."
...
```{#lst-governance .sql lst-cap="Gobernanza federada: propiedades de tabla y masking de PII"}
...
```{#lst-catalogs .sql lst-cap="Estructura de catálogos por dominio en Unity Catalog"}
...
```{#lst-dabs-domain .yaml lst-cap="Databricks Asset Bundle configurado por dominio de ventas"}
...
```{#lst-quality-monitor .sql lst-cap="Quality Monitor con métricas custom sobre un Data Product"}
